            ...
            <div className="py-8 mt-8">
              ...
              star
                ...
                <div className="flex justify-center gap-16">
                    <Link href="/">
                        <button
                            className="flex-grow w-32 mt-8 mx-auto max-w-7xl px-6 flex items-center justify-center bg-white text-black py-3 rounded-full text-2xl font-bold tracking-tight hover:bg-gray-100 transition-all">
                            Home
                        </button>
                    </Link>
